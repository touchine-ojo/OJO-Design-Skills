...
同じブリーフで、このスキルをインストールしたかどうかの比較。*(②③ 行はプレースホルダー —— [`comparison-prompts.md`](./comparison-prompts.md) で再生成できます。)*
...
<table>
  ...
  <tr>
    <td colspan="2" align="center"><sub><b>② コンポーネント詳細</b> —— アトミック Tailwind クラス + 完全な 8 状態モデル + スプリング物理 vs. 曖昧な散文。</sub></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2" align="center"><sub><b>③ 2 トラックのカバー範囲</b> —— 同じスキルが劇的なブランドストア(イノベーション)と控えめな SaaS ユーティリティ(コンベンション)のどちらも生成できます。</sub></td>
  </tr>
</table>

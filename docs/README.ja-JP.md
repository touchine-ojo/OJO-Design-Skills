...
同じブリーフで、このスキルをインストールしたかどうかの比較。*(プレースホルダー —— [`comparison-prompts.md`](./comparison-prompts.md) で再生成できます。)*
...
<table>
  ...
  <tr>
    <td align="center"><img src="../images/showcase-1-without.svg" alt="スキルなしのコーヒーアプリホーム" width="390"></td>
    <td align="center"><img src="../images/showcase-1-with.svg" alt="スキルありのコーヒーアプリホーム" width="390"></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><sub><b>① 全体感</b> —— ありきたりのグラデーション Hero と "Image" プレースホルダー vs. ブランドに根ざした実写のレイアウト。</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="../images/showcase-2-without.svg" alt="スキルなしのコンポーネント仕様" width="390"></td>
    <td align="center"><img src="../images/showcase-2-with.svg" alt="スキルありのコンポーネント仕様" width="390"></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><sub><b>② コンポーネント詳細</b> —— 曖昧な散文 vs. アトミック Tailwind クラス + 完全な 8 状態モデル + スプリング物理。</sub></td>
  </tr>
  <tr>
    <td align="center"><img src="../images/showcase-3-convention.svg" alt="コンベンショントラックの出力" width="390"></td>
    <td align="center"><img src="../images/showcase-3-innovation.svg" alt="イノベーショントラックの出力" width="390"></td>
  </tr>
  <tr>
    <td colspan="2" align="center"><sub><b>③ 2 トラックのカバー範囲</b> —— 同じスキルが控えめな SaaS ユーティリティ(コンベンション)と劇的なブランドストア(イノベーション)のどちらも生成できます。</sub></td>
  </tr>
</table>
